...
/*
// Adds an uninstall link in the plugins page - DOESN'T WORK AS CAN'T ACCESS THE UNINSTALL SCRIPT DIRECTLY :(
function suckerfishuninstall($links) {
	$settings_link = '<a href="'.WP_PLUGIN_URL.'/multi-level-navigation-plugin/uninstall.php">' . __('Uninstall') . '</a>';
	array_unshift( $links, $settings_link );
	return $links;
}
add_filter( 'plugin_action_links_' . $plugin, 'suckerfishuninstall' );*/
...
//wp_register_script('sortable_lists', $javascript_location.'sortable_lists.js', array('jquery-ui-sortable'), '0.1');
//wp_register_script('animatedcollapse', $javascript_location.'animatedcollapse.js','', '1.0');
...
<div class="wrap">
<form method="post" action="options.php" id="options"><?php echo wp_nonce_field('update-options'); ?><h2>PixoPoint Multi-level Navigation Plugin</h2>
